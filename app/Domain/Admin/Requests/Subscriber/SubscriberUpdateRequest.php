...
/**
 * Class SubscriberUpdateRequest
 * @package App\Domain\Subscriber\Requests\User
 */
class SubscriberUpdateRequest extends FormRequest implements IFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'required|string|email|max:255|unique:' . DBTable::USERS . ',email,' . $this->segment(3),
